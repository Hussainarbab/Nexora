...
export default function InternshipsPage() {
  ...
  const countries = [
    "All Countries",
    ...Array.from(
      new Set(internships.map((item) => item.country))
    ),
  ];
  ...
  const types = [
    "All Types",
    ...Array.from(
      new Set(internships.map((item) => item.type))
    ),
  ];
  ...
  const workplaces = [
    "All Workplaces",
    ...Array.from(
      new Set(internships.map((item) => item.workplace))
    ),
  ];
  ...
  const levels = [
    "All Levels",
    ...Array.from(
      new Set(internships.map((item) => item.level))
    ),
  ];
  ...
  const payments = [
    "All Payment",
    ...Array.from(
      new Set(internships.map((item) => item.payment))
    ),
  ];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-purple-100">
              Discover internships from companies around the
              world and gain real-world experience for your
              career.
            </p>
          </div>
